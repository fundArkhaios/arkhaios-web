    ...
    return(
		...
		<div className="m-4 min-h-[50vh] w-full max-w-sm lg:max-w-4xl">
			...
			<main className="shadow-xl grid bg-base-100 lg:aspect-[2/1] lg:grid-cols-2 h-full w-full">
				...
				<form className="flex flex-col justify-center gap-4 px-10 py-6 lg:px-16">
					
					<div className="flex flex-row">
                        <div className = "justify-start">
                            <label className="label" htmlFor="input1"><span className="label-text">First Name</span></label>
                            <input
                                type="text"
                                placeholder="john"
						...
						<div className = "px-10 justify-end">
                            <label className="label" htmlFor="input1"><span className="label-text">Last Name</span></label>
                            <input
                                type="text"
                                placeholder="doe"
					...
					<button onClick={register} className="btn btn-neutral" type="submit">Register</button>
					
					
					<div className="label justify-end">
						<Link className="link-hover link label-text-alt" href="/">Login to existing accout</Link>
					</div>
