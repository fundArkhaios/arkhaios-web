  ...
  return (
      ...
      <div className="pl-12 grid grid-cols-2 pt-12">
        <div className="justify-self-center max-w-5xl pl-10">
          ...
          <div className = "text-xl font-thin text-slate-200 py-2">$F: {fund.fundSymbol}</div>
          <div className = "text-xl font-light text-slate-200">Stage: {fund.fundRecruiting ? "Recruiting" : "Trading"}</div>
